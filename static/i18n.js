...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    new_skill: 'New skill',
    skills_tab_mine: 'My Skills',
    skills_tab_market: 'Skills Market',
    search_market_skills: 'Search market skills...',
    market_empty: 'No skills available.',
    market_no_results: 'No skills found.',
    market_error_prefix: 'Market error: ',
    market_install: 'Install',
    market_installing: 'Installing...',
    market_installed: 'Installed',
    market_upgrade: 'Upgrade',
    market_upgrading: 'Upgrading...',
    market_uninstall: 'Uninstall',
    market_badge: 'market',
    market_install_success: '{0} installed successfully',
    market_install_failed: 'Install failed: ',
    market_upgrade_success: '{0} upgraded successfully',
    market_upgrade_failed: 'Upgrade failed: ',
    market_upgrade_all: 'Upgrade All',
    market_upgrading_all: 'Upgrading...',
    market_updates_available: '{0} update(s) available',
    market_upgrade_all_confirm_title: 'Upgrade All Skills',
    market_upgrade_all_confirm_message: 'The following skills will be upgraded: {0}',
    market_uninstall_confirm_title: 'Uninstall Skill',
    ...
    settings_label_icenter: 'iCenter Channel',
    settings_desc_icenter: 'Enable iCenter (ZTE enterprise messaging). Auto-registers via bundled cli-uac.',
    icenter_no_cli_uac: 'cli-uac not found. iCenter unavailable.',
    icenter_connected: (id) => `Connected (${id})`,
    icenter_enabling: 'Enabling iCenter and registering…',
    icenter_disabling: 'Disabling iCenter…',
    icenter_disabled: 'iCenter disabled',
    icenter_enabled_restart: 'iCenter enabled. Gateway restarting…',
    icenter_enabled_no_restart: 'iCenter enabled. Restart the gateway to activate.',
    icenter_error: 'iCenter error',
    icenter_disconnected: 'iCenter disconnected — will reconnect automatically',
    icenter_reconnecting: 'iCenter reconnecting…',
    icenter_auto_reconnecting: 'iCenter disconnected — triggering reconnect…',
    ...
    onboarding_openclaw_detected: 'OpenClaw configuration detected. Would you like to import your skills and settings?',
    onboarding_openclaw_notice: 'Detected existing OpenClaw configuration',
    onboarding_openclaw_title: 'Import from OpenClaw',
    onboarding_openclaw_desc: 'Your OpenClaw skills, model settings and API keys can be imported with one click.',
    onboarding_sync_all: 'Import from OpenClaw',
    onboarding_configure_manual: 'Configure Manually',
    onboarding_syncing: 'Importing from OpenClaw…',
    onboarding_sync_success: 'Successfully imported from OpenClaw!',
    onboarding_sync_failed: 'Failed to import from OpenClaw',
    migrate_from_openclaw: 'Migrate',
    migrate_openclaw_title: 'Migrate Skills from OpenClaw',
    migrate_no_skills: 'No OpenClaw skills found.',
    migrate_select_all: 'Select All',
    migrate_deselect_all: 'Invert',
    migrate_will_overwrite: 'overwrite',
    migrate_button: 'Migrate {count} Skills',
    migrate_migrating: 'Migrating skills...',
    migrate_success: 'Successfully migrated {count} skills.',
    migrate_overwrite_note: '{count} existing skills will be overwritten.',
  ...
  zh: {
    ...
    new_skill: '新技能',
    save_skill: '保存技能',
    skills_tab_mine: '我的技能',
    skills_tab_market: '技能市场',
    search_market_skills: '搜索市场技能...',
    market_empty: '暂无可用技能。',
    market_no_results: '未找到技能。',
    market_error_prefix: '市场错误：',
    market_install: '安装',
    market_installing: '安装中...',
    market_installed: '已安装',
    market_upgrade: '升级',
    market_upgrading: '升级中...',
    market_uninstall: '卸载',
    market_badge: '市场',
    market_install_success: '{0} 安装成功',
    market_install_failed: '安装失败：',
    market_upgrade_success: '{0} 升级成功',
    market_upgrade_failed: '升级失败：',
    market_upgrade_all: '全部升级',
    market_upgrading_all: '正在升级...',
    market_updates_available: '有 {0} 项更新',
    market_upgrade_all_confirm_title: '升级所有技能',
    market_upgrade_all_confirm_message: '以下技能将被升级：{0}',
    market_uninstall_confirm_title: '卸载技能',
    ...
    settings_label_icenter: 'iCenter 频道',
    settings_desc_icenter: '启用 iCenter通道，通过UDS注册凭据，请保证UDS正常启用中',
    icenter_no_cli_uac: '未找到 cli-uac 程序，iCenter 不可用。',
    icenter_connected: (id) => `已连接（${id}）`,
    icenter_enabling: '正在启用 iCenter 并注册…',
    icenter_disabling: '正在禁用 iCenter…',
    icenter_disabled: 'iCenter 已禁用',
    icenter_enabled_restart: 'iCenter 已启用，网关正在重启…',
    icenter_enabled_no_restart: 'iCenter 已启用，请重启网关以激活。',
    icenter_error: 'iCenter 错误',
    icenter_disconnected: 'iCenter 已断开 — 将自动重连',
    icenter_reconnecting: 'iCenter 正在重连…',
    icenter_auto_reconnecting: 'iCenter 已断开 — 正在触发重连…',
    // onboarding
    ...
    onboarding_openclaw_detected: '检测到 OpenClaw 配置。是否导入您的技能和设置？',
    onboarding_openclaw_notice: '检测到已有的 OpenClaw 配置',
    onboarding_openclaw_title: '从 OpenClaw 导入',
    onboarding_openclaw_desc: '您的 OpenClaw 技能、模型设置和 API 密钥可以一键导入。',
    onboarding_sync_all: '从 OpenClaw 导入',
    onboarding_configure_manual: '手动配置',
    onboarding_syncing: '正在从 OpenClaw 导入…',
    onboarding_sync_success: '成功从 OpenClaw 导入！',
    onboarding_sync_failed: '从 OpenClaw 导入失败',
    migrate_from_openclaw: '迁移',
    migrate_openclaw_title: '从 OpenClaw 迁移技能',
    migrate_no_skills: '未找到 OpenClaw 技能。',
    migrate_select_all: '全选',
    migrate_deselect_all: '反选',
    migrate_will_overwrite: '将覆盖',
    migrate_button: '迁移 {count} 个技能',
    migrate_migrating: '正在迁移技能...',
    migrate_success: '成功迁移 {count} 个技能。',
    migrate_overwrite_note: '{count} 个已有技能已存在，选择将被覆盖。',
    migrate_failed: '迁移失败。',
